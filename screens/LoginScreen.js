            ...
            <View className="flex-1 bg-neutral-800">
                ...
                <View className="px-4 mt-4">
                    ...
                    <TouchableOpacity onPress={handleLoginWithGoogle} className="bg-red-600 px-4 py-3 rounded-lg mb-2">
                        <Text className="text-white text-center text-base font-semibold">Login with Google</Text>
                    </TouchableOpacity>
                    
                </View>

                <View className="flex-row justify-center items-center mx-4 pt-3 mb-6">
